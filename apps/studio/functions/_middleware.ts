...
import { installInstrumentationEdgeSink, type EdgeInstrumentationEnv } from './lib/instrumentation-sink.js';
...
export const onRequest: PagesFunction<EdgeInstrumentationEnv> = withInstrumentation(
  (ctx) => {
