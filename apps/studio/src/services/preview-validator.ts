...
// authored) and, in validatePreviewSample's case, literal user-entered
// form values — none of it is curated/structural data safe to capture.
...
export const formatIssuePath = withInstrumentation(
...
export const buildFieldValidator = withInstrumentation(
  ...
  { op: 'buildFieldValidator' }
);

export const buildSchemaValidator = withInstrumentation(
  ...
  { op: 'buildSchemaValidator' }
);

export const validatePreviewSample = withInstrumentation(
