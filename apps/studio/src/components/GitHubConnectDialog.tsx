...
export const GitHubConnectDialog = withInstrumentation(
  function GitHubConnectDialog({ authBase, onConnected, onCancel }: Props): React.ReactElement {
