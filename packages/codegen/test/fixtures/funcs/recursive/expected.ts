...
export function Double(input: { n: number }): number {
  input = { ...input, n: ((value) => { if (value == null) throw new Error("Argument 'n' requires a value"); return value; })(runeSingle(input.n)) };
  let result: number | undefined;
  result = runeSingle(runeBinary(input.n, input.n, (a, b) => a + b));
...
export function Triple(input: { n: number }): number {
  input = { ...input, n: ((value) => { if (value == null) throw new Error("Argument 'n' requires a value"); return value; })(runeSingle(input.n)) };
  let result: number | undefined;
  result = runeSingle(runeBinary(runeBinary(input.n, input.n, (a, b) => a + b), input.n, (a, b) => a + b));
