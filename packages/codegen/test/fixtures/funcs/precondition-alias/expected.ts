...
export function UsePayload(input: { wrapper: RuneFuncData<WrapperShape> }): string {
  input = { ...input, wrapper: ((value) => { if (value == null) throw new Error("Argument 'wrapper' requires a value"); return value; })(runeSingle(input.wrapper)) };
