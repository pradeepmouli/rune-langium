...
export function MakePoint(input: { x: number; y: number }): RuneFuncData<PointShape> {
  input = { ...input, x: ((value) => { if (value == null) throw new Error("Argument 'x' requires a value"); return value; })(runeSingle(input.x)), y: ((value) => { if (value == null) throw new Error("Argument 'y' requires a value"); return value; })(runeSingle(input.y)) };
  let result: RuneFuncData<PointShape> | undefined;
  result = runeSingle({ x: ((value) => { if (value == null) throw new Error("Argument 'x' requires a value"); return value; })(runeSingle(input.x)), y: ((value) => { if (value == null) throw new Error("Argument 'y' requires a value"); return value; })(runeSingle(input.y)) });
...
export function MakeEmptyBox(input: { w: number }): RuneFuncData<BoxShape> {
  input = { ...input, w: ((value) => { if (value == null) throw new Error("Argument 'w' requires a value"); return value; })(runeSingle(input.w)) };
  let result: RuneFuncData<BoxShape> | undefined;
  result = runeSingle({ origin: ((value) => { if (value == null) throw new Error("Argument 'origin' requires a value"); return value; })(runeSingle({})), width: ((value) => { if (value == null) throw new Error("Argument 'width' requires a value"); return value; })(runeSingle(input.w)) });
