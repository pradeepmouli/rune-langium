...
export function AddTwo(input: { a: number; b: number }): number {
  input = { ...input, a: ((value) => { if (value == null) throw new Error("Argument 'a' requires a value"); return value; })(runeSingle(input.a)), b: ((value) => { if (value == null) throw new Error("Argument 'b' requires a value"); return value; })(runeSingle(input.b)) };
  let result: number | undefined;
  result = runeSingle(runeBinary(input.a, input.b, (a, b) => a + b));
