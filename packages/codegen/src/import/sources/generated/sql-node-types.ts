 ...
 *
 * Generated from node_modules/@l1xnan/tree-sitter-sql/src/node-types.json by
...
export type SqlNodeKind = (typeof SQL_NODE_TYPES)[number]['type'];

/** The raw node-types.json entry for a given kind. */
export type SqlNodeEntry<K extends SqlNodeKind> = Extract<(typeof SQL_NODE_TYPES)[number], { type: K }>;

/** The field names the grammar declares for a given kind (never if it declares none). */
export type SqlNodeFields<K extends SqlNodeKind> = SqlNodeEntry<K> extends { fields: infer F } ? keyof F : never;
