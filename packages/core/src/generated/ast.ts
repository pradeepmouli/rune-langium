...
export interface AsOperation extends langium.AstNode {
  readonly $container:
    | ArithmeticOperation
    | AsKeyOperation
    | AsOperation
...
export function isAsOperation(item: unknown): item is AsOperation {
  return reflection.isInstance(item, AsOperation.$type);
}
...
export type RosettaTypedFeature = Attribute | RosettaMetaType | RosettaRecordFeature;
...
export interface Schema extends langium.AstNode {
  readonly $container: RosettaModel;
  readonly $type: 'Schema';
  annotations: Array<AnnotationRef>;
  format: langium.Reference<RosettaEnumValue>;
  name: ValidID;
}
...
export function isSchema(item: unknown): item is Schema {
  return reflection.isInstance(item, Schema.$type);
}
...
export class RuneDslAstReflection extends langium.AbstractAstReflection {
  override readonly types = {
    ...
    AsOperation: {
      name: AsOperation.$type,
      properties: {
        argument: {
          name: AsOperation.argument,
          optional: true
        },
        operator: {
          name: AsOperation.operator
        },
        type: {
          name: AsOperation.type,
    ...
    RosettaMetaType: {
      ...
      superTypes: [RosettaFeature.$type, RosettaRootElement.$type, RosettaSymbol.$type, RosettaTypedFeature.$type]
    },
    RosettaModel: {
