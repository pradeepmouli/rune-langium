---
name: speckit-copilot-instructions
description: 'Spec-kit workflow command: copilot-instructions'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: templates/commands/copilot-instructions.md
---

# Speckit Copilot-Instructions Skill
