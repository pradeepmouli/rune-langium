...
- `packages/visual-editor/src/adapters/cst-utils.ts` — source-range reconstruction post structured-clone.
- `ExpressionEditorSlotProps` + `renderExpressionEditor?(props)` — the slot the lens UX renders into.
